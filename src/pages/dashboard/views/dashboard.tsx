            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 h-96 shadow-sm flex flex-col">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={detailData.growth}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="actual" name="Actual Assets (T)" stroke="#3b82f6" strokeWidth={3} dot={{r: 4}} />
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 h-96 shadow-sm flex flex-col">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={detailData.adoption}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Area type="monotone" dataKey="mau" name="Monthly Active Users" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.3} />
                        ...
                        <td className="py-4 text-slate-600">
                          <div className="flex items-center gap-2">
                            <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                              <div className="h-full bg-blue-500" style={{width: `${(item.utilized/item.limit)*100}%`}}></div>
                            </div>
            ...
            <Bar dataKey="value" radius={[6, 6, 6, 6]}>
              {metric.data.map((entry: any, index: number) => {
                const isBad =
                  entry.type === "bad" ||
                  (entry.type === "mixed" && entry.isHighlighted);
                const barColor = isBad ? "#ef4444" : "#3b82f6";
